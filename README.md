...
5. Export the recommended purchase order CSV.
6. Copy the generated project summary draft for the hackathon submission.
...
- Add charts for demand velocity and stockout timeline
