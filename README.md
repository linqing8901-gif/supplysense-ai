...
It forecasts SKU-level stockout risk from current stock, recent demand, lead time, and open orders, then recommends reorder quantities and generates planner-friendly explanations.
...
4. Select a high-risk SKU to show the explanation panel.
5. Copy the generated project summary draft for the hackathon submission.

## CSV Columns

```text
sku,name,category,current_stock,lead_time_days,supplier,on_order,last_14d_sales,unit_cost
```
...
- Add supplier delay risk
- Add CSV export for recommended purchase orders
